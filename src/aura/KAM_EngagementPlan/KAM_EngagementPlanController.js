({
    ...
    handleOnAddEngagement : function (component, event, helper) {
        helper.createEngagementModal (component);
    },
    handleOnRequestEditEngagement :function (component, event, helper) {
        helper.riseRequestForEngagementPlanEdit (component, event);
    },
    onEngagementPlanUpdated : function(component, event, helper) {
        helper.onEngagementPlanUpdated (component, event);
